...
bool cdr_serialize_motor_control_command_msgs__msg__MotorControlCommand(
  const motor_control_command_msgs__msg__MotorControlCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
  {
  ...
  // Field name: motors
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_motor_control_command_msgs__msg__Motor(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_control_command_msgs
bool cdr_deserialize_motor_control_command_msgs__msg__MotorControlCommand(
  eprosima::fastcdr::Cdr & cdr,
  motor_control_command_msgs__msg__MotorControlCommand * ros_message)
{
  // Field name: id
  {
    std::string tmp;
  ...
  // Field name: motors
  {
    ...
    auto array_ptr = ros_message->motors.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_motor_control_command_msgs__msg__Motor(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_control_command_msgs
bool cdr_serialize_key_motor_control_command_msgs__msg__MotorControlCommand(
  const motor_control_command_msgs__msg__MotorControlCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
  ...
  // Field name: motors
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_motor_control_command_msgs__msg__Motor(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_control_command_msgs
size_t get_serialized_size_key_motor_control_command_msgs__msg__MotorControlCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorControlCommand__ros_msg_type * ros_message = static_cast<const _MotorControlCommand__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: motors
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_motor_control_command_msgs__msg__Motor(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_control_command_msgs
size_t max_serialized_size_key_motor_control_command_msgs__msg__MotorControlCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_motor_control_command_msgs__msg__Motor(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const motor_control_command_msgs__msg__MotorControlCommand * ros_message = static_cast<const motor_control_command_msgs__msg__MotorControlCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_motor_control_command_msgs__msg__MotorControlCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  motor_control_command_msgs__msg__MotorControlCommand * ros_message = static_cast<motor_control_command_msgs__msg__MotorControlCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_motor_control_command_msgs__msg__MotorControlCommand(cdr, ros_message);
}
